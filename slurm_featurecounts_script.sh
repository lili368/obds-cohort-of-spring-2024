...
featureCounts -p -t exon -g gene_id  -T 12 -a ./genome/Mus_musculus.GRCm38.102.gtf.gz -o ./quantification/featureCounts_output_ERR1755082.csv ./mapped_reads/ERR1755082_sorted.bam
