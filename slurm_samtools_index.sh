...
samtools view -h -b -@ 12 mapped_reads/ERR1755082.sam > mapped_reads/ERR1755082.bam
samtools sort -@ 12 mapped_reads/ERR1755082.bam  > mapped_reads/ERR1755082_sorted.bam
samtools index -@ 12 mapped_reads/ERR1755082_sorted.bam
